...
public class GetCentreScoreTest {
    ...
    public void testHalfNHalf() {
        ...
        for (int i = 0; i<30; i = i+5) {
            String die = dies[random.nextInt(13)];
            String position = centrecol[random.nextInt(4)] + centrerow[random.nextInt(4)] + "";
            String ori = Integer.toString(random.nextInt(8));
            placement = placement + die + position + ori;
        }
    }
    */
    @Test
